...
void FractalMaker::sierpinskiTriangle(int numRecursions) {
    ...
    while (window.isOpen())
    {
        ...
        if( numRecursions >= 4){
            ...
            drawTriangle(left, top, right, sf::Color(0, 0, 255), true, 0.125, 416, 384);

            // 192 + 32 = 224  right right
            // 192/2 = 96 left left
            // 320 / 2 = 160 top top
            drawTriangle(left, top, right, sf::Color(0, 0, 255), true, 0.125, 224, 512);
            drawTriangle(left, top, right, sf::Color(0, 0, 255), true, 0.125, 96, 512);
            drawTriangle(left, top, right, sf::Color(0, 0, 255), true, 0.125, 160, 384);
